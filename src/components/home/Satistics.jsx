...
const Satistics =  () => {
  return (
    <div className='w-[90%] flex items-center mx-auto justify-center lg:mt-80 xl:mt-[600px] mb-[400px] text-[#1C1F35]'>
            <div className='flex justify-evenly items-center gap-3 py-11 lg:px-10 xl:px-24 border-y border-r border-[#D4D4D4]'>
