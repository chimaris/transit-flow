...
const TransportCard = ({names, bg, textSize}) => {
    return (
        <div className={`bg-contain bg-no-repeat lg:h-[380px] w-full lg:w-[230px] pl-4 pt-56 ${bg}`}>
...
const Transport = () => {
  return (
    <div className='lg:relative w-full'>
        <div className="w-full h-[400px] hidden lg:block" style={{background: "linear-gradient(95deg, #FFB629 -1.19%, #FFDA56 57.78%, #FFD7A6 115.08%)"}}></div>
        <div className='flex flex-col items-center gap-2 mx-auto lg:absolute lg:left-32 -top-96 lg:py-[85px] w-[80%]'>
            <h2 className='text-[#1C1F35] text-[35px] font-semibold py-6' style={{fontFamily: 'Rubik'}}>Transporting Across The World</h2>
            <div className='flex flex-col lg:flex-row text-white gap-2'>
