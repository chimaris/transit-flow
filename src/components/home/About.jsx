...
const About = () => {
  return (
    <div className='relative'>
        <div className="w-full bg-[url('/about-background.svg')] h-[504px] bg-contain bg-no-repeat"></div>
        <div className='flex justify-center w-[90%] gap-24 absolute lg:left-[65px] xl:left-[75px] -bottom-96 bg-white p-[85px]'>
            ...
            <img src={lady} alt="lady" loading="lazy" className='absolute md:right-[200px] xl:right-[350px] bottom-10' />
        </div>
    </div>
  )
}
