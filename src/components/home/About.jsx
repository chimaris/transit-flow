...
const About = () => {
  return (
    <div className='relative'>
        ...
        <div className='flex justify-center w-[90%] gap-24 absolute left-[60px] -bottom-96 bg-white p-[85px]'>
            ...
            <img src={lady} alt="lady" className='absolute right-[448px] bottom-10' />
        </div>
    </div>
  )
}
