...
const Hero = () => {
  return (
    <div className="lg:w-[90%] xl:w-[80%] mx-auto mt-[150px]">
      <div className="flex flex-col gap-4 w-[571px]" style={{fontFamily:'Rubik'}}>
        ...
        <Button content={'Explore now'} style={{background: "linear-gradient(94.06deg, #FFB629 -1.21%, #FFDA56 58.66%, #FFD7A6 116.84%)",color:'#23212A', width:'196px'}}/>
    </div>
    </div>
